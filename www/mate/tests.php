...
class Example1 extends Common
{
	...
	function initiateEditor()
	{
		...
		$tableColumns['cable_number']   = array('display_text' => 'Line Description', 'perms' => 'VCTXQ','join' => array('table' => 'cables', 'column' => 'cable_number', 'display_mask' => "concat('line no.',cables.cable_number,': ',cables.description)", 'type' => 'left'));
		$tableColumns['test_time']  = array('display_text' => 'Time', 'perms' => 'VCTXQ');
		$tableColumns['result']     = array('display_text' => 'Result', 'perms' => 'VCTXQ');
		$tableColumns['old_length'] = array('display_text' => 'Old Length', 'perms' => 'VCTXQ');
		$tableColumns['new_length'] = array('display_text' => 'New Length', 'perms' => 'VCTXQ');
