...
class Example1 extends Common
{
	...
	{
	    $tableColumns['admin_id'] = array('display_text' => 'Id', 'perms' => '');
		$tableColumns['name']     = array('display_text' => 'Name', 'perms' => 'ATVQSXOE');
		$tableColumns['mobile']   = array('display_text' => 'Mobile', 'perms' => 'ATVQSXOE');
		$tableColumns['email']    = array('display_text' => 'Email', 'perms' => 'ATVQSXOE');
		$tableColumns['password']    = array('display_text' => 'Password', 'perms' => 'ATVQSXOE');
		...
		$this->Editor->setConfig('tableTitle','Contacts');
	}
