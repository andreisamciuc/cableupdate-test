...
<html lang="en">
	<head>
        ...
        <link type="text/css" rel="stylesheet" href="css/pdntime.css"/>
        ...
        <script type="text/javascript" src="js/pdntime.js"></script>
			...
			<script type="text/javascript">
			 ...
			 <div id="header">
             	...
             	<ul id="account_info" class="pull-right">
                     <li class="setting" > 
                      <div id="servertime">
	                     	<span class="icon-time" onclick="javascript:pdntime.launch();"></span>
	                     	<img src="images/loader/loader_blue.gif"/> Loading..
                      </div>
                     </li>
					
					 <li class="setting">
						<span class="icon-user"></span>Logged in as <b class="red">
                        <?php echo $_SESSION['user_name']; ?></a></b>  
                     </li>
				
 	                 <li class="logout"><a href="#"><span class="icon-signout"></span> Logout</a>
 	                 </li>
                </ul>
